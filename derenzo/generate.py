...
DEFAULT_MATERIAL_FILE = '/home/lvli/Documents/incident/derenzo/range_material_phantomD.dat'
DEFAULT_ACTIVITY_FILE = '/home/lvli/Documents/incident/derenzo/activity_range_phantomD.dat'

f = tables.open_file('/home/lvli/derenzo.h5')
derenzo, value = f.root.derenzo.derenzo[int(sys.argv[1])]
a = [0, value[0], value[1]]
b = [0, value[0], value[1]]
c = ['Air', 'Air', 'Air']
...
derenzo.tofile("/home/lvli/Documents/incident/derenzo/phantomD.bin")
